(function ($) {
    ...
    if (bodyRtl) {
        ...
        (document.getElementById("style").setAttribute("href", "/static/plugins/bootstrap/css/bootstrap.rtl.min.css"));
...
$(document).on("click", '#myonoffswitch23', function () {
    if (this.checked) {
        ...
        $("head link#style").attr("href", $(this));
        (document.getElementById("style").setAttribute("href", "/static/plugins/bootstrap/css/bootstrap.min.css"));
        var carousel = $('.owl-carousel');
        $.each(carousel, function (index, element) {
            // element == this
            var carouselData = $(element).data('owl.carousel');
